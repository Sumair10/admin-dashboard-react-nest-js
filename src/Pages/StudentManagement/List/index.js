    ...
    const remappedStudents =
      ...
      students.map((student) => {
        ...
        return {
          ...
          parent:
            student.parentId && student.parentId.name
              ? student.parentId.name
              : "---",
          parentContact:
            student.parentId && student.parentId.contact
              ? student.parentId.contact
              : "---",
    ...
    const remappedStudentReport =
      ...
      students.map((student) => {
        ...
        return {
          ...
          Address:
            student.location && student.location.address
          ...
          Medical_Instructions: student.medicalInstructions
            ? student.medicalInstructions
            : "---",
      ...
      if (student["Name(required)"] && student["Class(required)"]) {
        formattedStudent.push({
          ...
          parentDetails: {
            ...
            email: student["Parent Email(required)"]
              ? student["Parent Email(required)"]
              : null,
            contact: student["Parent Phone Number(required)"]
              ? student["Parent Phone Number(required)"]
              : null,
          },
        });
      }
